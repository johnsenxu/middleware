...
public class RaceConfig implements Serializable {
    ...
    public static String TeamCode = "45833zplkh";
    public static String JstormTopologyName = "45833zplkh";
    public static String MetaConsumerGroup = "45833zplkh";
    ...
    public static Integer TairNamespace = 49747;
}
